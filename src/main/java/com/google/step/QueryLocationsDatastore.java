...
public class QueryLocationsDatastore extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ArrayList<String> formLocationOptions = new ArrayList<>();
        String cityName = "";
        ...
        sendFormCityOptions(formLocationOptions);
    ...
    public void sendFormCityOptions(ArrayList<String> locations) {
        Gson gson = new Gson();
